$(document).ready(function () {
 ...
 $("#datatablesSimple1").on('click','#deleteRow',function(){
    ...
    $.ajax({
      ...
      method: "DELETE",
      url: "http://localhost:8091/admin/unit/GHGEcart/deletecarddetails/"+unitName,
...
function saveTable() {
    ...
    $.ajax({
        ...
        url: "http://localhost:8091/admin/unit/GHGEcart/addcardDetails",
    }).done(function (data) {
       alert(data);
     })
}
    ...
    { 
     $.ajax({
        headers: {
         ...
         method: "GET",
         url: "http://localhost:8091/admin/unit/GHGEcart/getcardDetails",
       }).done(function (data) {
